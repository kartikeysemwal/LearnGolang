...
func (app *Config) logItemViaRPC(w http.ResponseWriter, payload LoggerPayload) {
	...
	// name of the RPC function which we want to execute, with the payload and pointer to result string
